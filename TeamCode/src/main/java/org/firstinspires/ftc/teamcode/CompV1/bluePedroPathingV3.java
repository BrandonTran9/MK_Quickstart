...
public class bluePedroPathingV3 extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                PedroComponent.follower().followPath(StartToShoot);
                setPathState(1);
                break;
            case 1:
            ...
            */
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    PedroComponent.follower().followPath(ShootToGPP,true);
                    setPathState(2);
                }
                break;
            case 2:
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    PedroComponent.follower().followPath(PickupGPP,true);
                    setPathState(3);
                }
                break;
            case 3:
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are grabbing the sample */
                    PedroComponent.follower().followPath(GPPToShoot,true);
                    setPathState(4);
                }
                break;
            case 4:
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are scoring the sample */
                    PedroComponent.follower().followPath(ShootToPGP,true);
                    setPathState(5);
                }
                break;
            case 5:
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are grabbing the sample */
                    PedroComponent.follower().followPath(PickupPGP,true);
                    setPathState(6);
                }
                break;
            case 6:
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are scoring the sample */
                    PedroComponent.follower().followPath(PGPToShoot, true);
                    setPathState(7);
                }
                break;
            case 7:
                ...
                if(!PedroComponent.follower().isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are scoring the sample */
                    PedroComponent.follower().followPath(StrafeL, true);
                    setPathState(8);
                }
                break;
            case 8:
...
//        follower = Constants.createFollower(hardwareMap);
    ...
    public void onStop() {
        ...
        blueSimple.autoEndPose = PedroComponent.follower().getPose();
    }
}